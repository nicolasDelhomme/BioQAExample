...
meta <- read.delim(here("~/raw_data/airway/airway_meta.txt"), 
...
fc <- readRDS(here("~/raw_data/airway/featureCounts/star_featureCounts.rds"))
names(fc)
...
salmonfiles <- here("~/raw_data/airway/salmon/", meta$names, "/quant.sf")
